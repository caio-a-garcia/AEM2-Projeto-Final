...
```{r}
df_semcluster <- read.csv("data/df_pre_processamento_semcluster.csv")
...
#write_csv(rf_best_hip, "data/rf_best_hip_semcluster.csv")

#rf_best_hip
```

```{r}
# Lendo arquivo CSV com hiperparametros otimizados
rf_best_hip <- read.csv("data/rf_best_hip_semcluster.csv")
...
#write_csv(boosting_best_hip, "data/boosting_best_hip_semcluster.csv")
...
Salvando resultados para comparação com a modelagem com cluster

```{r}
write_csv(df_semcluster_results, "data/df_semcluster_results.csv")
```
